...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter{
	...
	//A anotação @Bean indica que o metod será gerenciado pelo Spring
	...
	// configurações das rotas para serem abertas o não
    @Override
    protected void configure(HttpSecurity http) throws Exception{
    	...
    	.antMatchers("/auth","/auth/**", "/configuration/security", "/webjars/**", "/user/**", "/v2/api-docs", "/swagger-resources/**", "/swagger-ui.html")
